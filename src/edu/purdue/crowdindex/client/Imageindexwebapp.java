...
public class Imageindexwebapp implements EntryPoint {
    ...
    private void getTask(){
        ...
        if(resultSend){
            greetingService.getTask(textToServer,
    ...
    private void addVerticalFlowPanelText() {
        ...
        if(dataset.equals("1")){
            ...
            l = new HTML(new SafeHtmlBuilder().appendEscapedLines("You are given the following image of the square under question:\r\n\r\n").toSafeHtml());
            ...
            l = new HTML(new SafeHtmlBuilder().appendEscapedLines(queryText).toSafeHtml());
            l.setStyleName("instructionlabel");
            fPanelRight.add(l);
        }
        else{
            l = new HTML(new SafeHtmlBuilder().appendEscapedLines("You are given the following images of the car under question:\r\n\r\n").toSafeHtml());
            l.setStyleName("instructionlabel");
            fPanelRight.add(l);
    ...
    private void sendResultToServer(String result) {
        ...
        if(selectedResult.equals(Constants.Unselected_item)){
            ...
            errorLabel.setText("Result already send to server please get another task");
        }
        else  if(!resultSend){
            String toSend = taskId+";"+userId+";"+result+";"+taskType;
            greetingService.returnResult(toSend,
                    new AsyncCallback<String>() {
                @Override
                public void onFailure(Throwable caught) {
                ...
                public void onSuccess(String result) {
                    ...
                    if(bar.getProgress()<Constants.MaxUserTasks){
                        ...
                        // we can get more tasks
                        // show a message to tell him that and if he wants to re-take the survey reinitialize
                    }
    ...
    public void onModuleLoad() {
        ...
        fPanelMiddle.setHorizontalAlignment(HasHorizontalAlignment.ALIGN_CENTER);
        ...
        warninglabel = new Label("Please DO NOT USE Your Purdue Account information.");
        ...
        Timer t = new Timer() {
            ...
            public void run() {
                if(!(userId ==null ||"".equals(userId))){
                    greetingService.getAvailTask(userId,  new AsyncCallback<String>(){
                        ...
                        public void onSuccess(String result) {
                            String [] s = result.split(",");
                            taskAvailableLable.setText(s[0]+" tasks avaiable");
                        }
        ...
        signUpButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                if(!("".equals(nameField.getText())||"".equals(passwordField.getText()))){
                    greetingService.signUp(nameField.getText()+";"+passwordField.getText(), new AsyncCallback<String>() {
    ...
    void addRegisterUserHandler(){
        registerUserButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if(!("".equals(nameField.getText())||"".equals(passwordField.getText()))){
                    greetingService.registerUser(nameField.getText()+";"+passwordField.getText(),
                            new AsyncCallback<String>() {
                        @Override
                        public void onFailure(Throwable caught) {
                            errorLabel.setText(SERVER_ERROR);
                            ...
                            if(result.contains ("Login successfull")){
                                ...
                                greetingService.getAvailTask(userId,  new AsyncCallback<String>(){
                                    ...
                                    public void onSuccess(String result) {
                                        ...
                                        bar.setProgress(Integer.parseInt(s[1]));
                                        progress = Integer.parseInt(s[1]);
